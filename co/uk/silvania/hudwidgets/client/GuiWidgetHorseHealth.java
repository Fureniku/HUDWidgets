...
public class GuiWidgetHorseHealth extends GuiWidgetBase {
	...
	public void onRenderGui(RenderGameOverlayEvent event) {
		...
		if(mc.thePlayer.isRidingHorse() || HUDWidgetsConfig.alwaysRenderHorseHealth) {
			...
			if (enabled) {
				...
				int configX = HUDWidgetsConfig.horseHealthXPos;
				int configY = HUDWidgetsConfig.horseHealthYPos;
				...
				if (HUDWidgetsConfig.textHorseHealth) {
					...
					GL11.glScalef(0.5F, 0.5F, 0.5F);
					font.drawStringWithShadow("Horse Health:", (xPos) + 22, (yPos) + 6, 0xFFFFFF);
				}
				GL11.glPopMatrix();
			}
		}
